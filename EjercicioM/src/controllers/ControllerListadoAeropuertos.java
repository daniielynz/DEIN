...
public class ControllerListadoAeropuertos {
	...
	@FXML
    void initialize() {
		// Creamos los tooltips y se los añadimos
		Tooltip tooltip = new Tooltip("Selecciona un Aeropuerto para modificar o borrar un aeropuerto");
        tableAeropuertosPrivados.setTooltip(tooltip);
        tableAeropuertosPublicos.setTooltip(tooltip);
     ...
     // ponemos evento al TextField del filtrado por nombre
        ...
        modifyItem.setOnAction(e -> {
        	if(rbPrivados.isSelected()) {
        		// Si esta seleccionado el radiobutton de aeropuertos privados
        		AeropuertoPrivado p = tableAeropuertosPrivados.getSelectionModel().getSelectedItem();
        		// si se ha seleccioando un Aeropuerto
        		if (p != null) {
            		ControllerEditarAeropuerto c = new ControllerEditarAeropuerto();
            		c.editarAeropuerto();
                }
        	}else if(rbPublicos.isSelected()) {
        		// Si esta seleccionado el radiobutton de aeropuertos publicos
        		AeropuertoPublico p = tableAeropuertosPublicos.getSelectionModel().getSelectedItem();
        		// si se ha seleccioando un Aeropuerto
        		if (p != null) {
            		ControllerEditarAeropuerto c = new ControllerEditarAeropuerto();
        ...
        // Accion de borrar aeropuerto en el menu contextual
        ...
        tableAeropuertosPrivados.setContextMenu(contextMenu);
        tableAeropuertosPublicos.setContextMenu(contextMenu);
